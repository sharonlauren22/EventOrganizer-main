        ...
        <div class="row py-2">
            <div class="col-6 px-3">
                ...
                <input type="text" name="website_link"
                    class="form-control border border-black col"value={{ $organizer->website_link }}>
            </div>
        </div>
        <div class="row py-2">
            <div class="col-12 px-3">
                ...
                <textarea name="description" hidden id="description">{!! $organizer->description !!}</textarea>
